...
var select = function(el) {
  ...
  flower = select("svg")
  confettiBtn = select("btn-confetti");
  const songs = {
  'btn-happy': document.getElementById('bg-happy'),
  'btn-crazy': document.getElementById('bg-crazy'),
  'btn-sexy':  document.getElementById('bg-sexy'),
  'btn-cool':  document.getElementById('bg-cool'),
};
  playingMusic = false;
  current = null;
